...
<head>
    ...
    <title>Admin</title>
    <link href="<?php echo base_url() . '/public/admin_assets/css/bootstrap.css';?>" rel="stylesheet" />
    ...
    <style>
        ...
        .auth.auth-bg-1 {
            background: url(public/assets_admin/img/login_1.jpg);
            ...
            <div class="row w-100">
                <div class="col-lg-4 mx-auto">
                    <div class="auto-form-wrapper">
                        <form action="<?php echo base_url('Admin_controller/loginAuth'); ?>" method="post">
                        <?php echo csrf_field(); ?>
